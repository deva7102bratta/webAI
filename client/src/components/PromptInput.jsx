...
import {  CloudUploadIcon,  Loader2Icon,  MicIcon,  ArrowUpIcon} from "lucide-react"
        ...
        <div className="flex items-center justify-between pb-3 px-3 gap-2">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <button
              ...
              className="flex items-center justify-center p-1.5 rounded-full bg-blue-600 text-white hover:bg-red-700 disabled:opacity-40 cursor-pointer"
              type="submit"
            >
              {loading ? (
